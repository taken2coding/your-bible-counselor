...
<div class="hero">
  ...
  <img src="/Assets/logo_main.png" alt="Your Bible Counselor logo" style="width:130px;height:auto;background:transparent;border-radius:0;padding:0;filter:drop-shadow(0 8px 24px rgba(0,0,0,0.28));margin:0 auto 14px;display:block;animation:fadeUp 0.6s ease">
